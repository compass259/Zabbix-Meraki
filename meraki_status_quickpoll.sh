...
#The complete script takes approximatetly one second to complete per 75 devices.
...
#This script is meant to be scheduled at a regular short interval, such as every five minutes, to provide the best picture of the Meraki network environment.

cd /usr/share/zabbix/externalscripts	#added for 
